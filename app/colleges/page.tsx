...
import { Search, Star, Calendar, Microscope, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="text-center py-20 text-brand-medium">
            Loading colleges...
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {colleges.map((college: any) => (
              <div
                key={college._id}
                className="bg-white rounded-2xl shadow-lg border border-brand-light overflow-hidden hover:shadow-2xl transition duration-300 group"
              >
                {/* Image */}
                  ...
                  <div className="space-y-2 text-sm text-gray-600 mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Research:{" "}
                        <span className="font-semibold">
                          {college.researchCount || 50}+ Projects
                        </span>
                      </span>
                    </div>
                  </div>
